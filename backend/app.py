...
_CANONICAL_LOCATIONS = [
    # ── Existing hub and seed facilities ────────────────────────────────────────
    {
        'id': 'hub-01',
    ...
    # ── Expanded facility dataset — verified coordinates from OpenStreetMap ─────
    # PHC facilities (Khordha / Bhubaneswar region)
    {
        'id': 'phc-chandaka-n',
        'name': 'PHC Chandaka(N)',
        'type': 'phc',
        ...
        'lat': 20.3705,
        'lng': 85.7707,
        'contact': '+91-674-2300010',
        'address': 'Khandagiri-Chandaka Road, Chandaka, Bhubaneswar, Odisha 752054',
    },
    {
        'id': 'phc-sarakana',
        'name': 'PHC Sarakana',
        ...
        'lat': 20.2324,
        'lng': 85.9138,
        'contact': '+91-674-2300011',
        'address': 'Dibakar Marg, Balianta, Khordha, Odisha 752101',
    },
    {
        'id': 'phc-itipur',
        'name': 'PHC Itipur(N)',
        ...
        'lat': 20.2003,
        'lng': 85.8335,
        'contact': '+91-674-2300012',
        'address': 'Bhubaneswar-Puri Highway, Uttara, Khordha, Odisha 751002',
    },
    {
        'id': 'phc-benupur',
        'name': 'PHC Benupur',
        ...
        'lat': 20.2920,
        'lng': 85.9013,
        'contact': '+91-674-2300013',
        'address': 'Jayadev Marga, Balikanthia, Balianta, Khordha, Odisha 752101',
    },
    {
        'id': 'phc-khandakai',
        'name': 'PHC Khandakai',
        ...
        'lat': 20.2653,
        'lng': 85.7805,
        'contact': '+91-674-2300014',
        'address': 'Khandagiri-Chandaka Road, Khandakai, Bhubaneswar, Odisha 752011',
    },
    {
        'id': 'phc-retanga',
        'name': 'PHC Retanga',
        ...
        'lat': 20.2029,
        'lng': 85.7595,
        'contact': '+91-674-2300015',
        'address': 'AIIMS Hospital Road, Khandagiri, Khordha, Odisha 752054',
    },
    # PHC facilities (Arada / Cuttack region)
    {
        'id': 'phc-arada',
        'name': 'PHC Arada',
        'type': 'phc',
        ...
        'lat': 20.3724,
        'lng': 85.9423,
        'contact': '+91-671-2300020',
        'address': 'SH60, Ward 4, North Zone, Balianta, Cuttack, Odisha 753011',
    },
    {
        'id': 'phc-baranga',
        'name': 'PHC Baranga',
        ...
        'lat': 20.4090,
        'lng': 85.8283,
        'contact': '+91-671-2300021',
        'address': 'Nandankanan Road, Barang, Cuttack, Odisha 754005',
    },
    {
        'id': 'phc-gurudijhatia',
        'name': 'PHC Gurudijhatia',
        'type': 'phc',
        'district': 'Cuttack',
        'lat': 20.5633,
        'lng': 85.8043,
        'contact': '+91-671-2300022',
        'address': 'NH-16 Bypass, Gurudijhatia, Cuttack, Odisha 754028',
    },
    # PHC facilities (Puri region)
    {
        'id': 'phc-dolamandap',
        'name': 'PHC Dolamandap(N)',
        'type': 'phc',
        'district': 'Puri',
        'lat': 19.8058,
        'lng': 85.8196,
        'contact': '+91-675-2300030',
        'address': 'Grand Road, Swargadwara, Puri, Odisha 752003',
    },
    # CHC facilities (Khordha region)
    {
        'id': 'chc-mendhasal',
        'name': 'CHC Mendhasal',
        'type': 'chc',
        ...
        'lat': 20.2712,
        'lng': 85.6982,
        'contact': '+91-674-2300040',
        'address': 'Mendhasal, Khordha, Odisha 752019',
    },
    {
        'id': 'chc-balipatna',
        'name': 'CHC Balipatna',
        ...
        'lat': 20.1872,
        'lng': 85.9715,
        'contact': '+91-674-2300041',
        'address': 'Balipatna, Khordha, Odisha 752101',
    },
    {
        'id': 'chc-balakati',
        'name': 'CHC Balakati',
        ...
        'lat': 20.2034,
        'lng': 85.8686,
        'contact': '+91-674-2300042',
        'address': 'Balakati, Khordha, Odisha 752101',
    },
    # CHC facilities (Cuttack region)
    {
        'id': 'chc-mahidharpada',
        'name': 'CHC Mahidharpada',
        'type': 'chc',
        'district': 'Cuttack',
        'lat': 20.3411,
        'lng': 85.9197,
        'contact': '+91-671-2300050',
        'address': 'Mahidharpada, Cuttack, Odisha 754001',
    },
    # CHC facilities (Puri region)
    {
        'id': 'chc-chandanpur',
        'name': 'CHC Chandanpur',
        'type': 'chc',
        ...
        'lat': 19.8956,
        'lng': 85.8080,
        'contact': '+91-675-2300060',
        'address': 'Chandanpur, Puri, Odisha 752002',
    },
    {
        'id': 'chc-sakhigopal',
        'name': 'CHC Sakhigopal',
        ...
        'lat': 19.9460,
        'lng': 85.8206,
        'contact': '+91-675-2300061',
        'address': 'Sakhigopal, Puri, Odisha 752014',
    },
    {
        'id': 'chc-rebana-nuagaon',
        'name': 'CHC Rebana Nuagaon',
        'type': 'chc',
        'district': 'Puri',
        'lat': 19.7980,
        'lng': 85.6786,
        'contact': '+91-675-2300062',
        'address': 'Rebana Nuagaon, Puri, Odisha 752003',
    },
    # CHC facilities (Ganjam region)
    {
        'id': 'chc-berhampur',
        'name': 'CHC Berhampur',
        'type': 'chc',
